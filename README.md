...
## Как это работает — 31 секунда

[![Демонстрация: старт, выбор пяти мер, итог, сравнение сценариев, паводок и мобильность](akim/ui/docs/demo/akim-desktop.gif)](akim/ui/docs/demo/akim-desktop.mp4)

[Открыть видео MP4 в полном размере — 1440 × 1000](akim/ui/docs/demo/akim-desktop.mp4) · [Попробовать самостоятельно](https://sim-astana.diaskhalniyasov.workers.dev)

Пошаговая демонстрация из восьми реальных экранов приложения, без звука. Записана локальная версия без API-ключей: старт → брифинг → район → пять решений → итог → сравнение → паводок → мобильность. GIF служит коротким обзором; в MP4 текст можно рассмотреть в полном размере.
